...
internal static partial class Interop
{
    internal static partial class Unix
    {
        ...
        internal struct ErrorInfo
        {
            ...
            {
                _error = Interop.Unix.Sys.ConvertErrorPlatformToPal(errno);
                _rawErrno = errno;
            }
            ...
            {
                get { return _rawErrno == -1 ? (_rawErrno = Interop.Unix.Sys.ConvertErrorPalToPlatform(_error)) : _rawErrno; }
            }

            internal string GetErrorMessage()
            {
                return Interop.Unix.Sys.StrError(RawErrno);
            }
...
internal static class InteropErrorExtensions
{
    ...
    // enum.
    public static Interop.Unix.ErrorInfo Info(this Interop.Unix.Error error)
    {
        return new Interop.Unix.ErrorInfo(error);
    }
}
